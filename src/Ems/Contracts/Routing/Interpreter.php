 ...
 *
 * The Interpreter is the most important part of the routing process. You add
 ...
 */
interface Interpreter extends Arrayable
{
    /**
    ...
    /**
     * Find the handler for $method and $url that someone did add().
     *
     * @param string   $method
     * @param string   $uri
     *
