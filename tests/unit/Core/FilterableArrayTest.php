...
class FilterableArrayTest extends TestCase
{
    ...
    #[Test] public function get_and_set_source()
    {
        $source = ['foo' => 'bar'];
        $array = $this->make();
    ...
    #[Test] public function set_non_array_Like_source_throws_error()
    {
        $this->expectException(TypeError::class);
        $this->make('hello');
    }

    #[Test] public function set_non_iterable_source_throws_error()
    {
        $this->expectException(TypeError::class);
    ...
    #[Test] public function ArrayAccess_forwards_to_source()
    {
    ...
    #[Test] public function toArray_returns_array()
    {
        $source = ['foo' => 'bar', 'a' => 'b', 'all' => [1,2,3]];
        $array = $this->make($source);
    ...
    #[Test] public function toArray_returns_arrayable()
    {
    ...
    #[Test] public function toArray_returns_iterable()
    {
        $source = ['foo' => 'bar', 'a' => 'b', 'all' => [1,2,3]];
    ...
    #[Test] public function clear_clears_on_array()
    {
        $source = ['foo' => 'bar', 'a' => 'b', 'all' => [1,2,3]];
        $array = $this->make($source);
        $array->clear();
    ...
    #[Test] public function clear_clears_on_ArrayData()
    {
        $source = ['foo' => 'bar', 'a' => 'b', 'all' => [1,2,3]];
    ...
    #[Test] public function clear_clears_selected_keys()
    {
        $source = ['foo' => 'bar', 'a' => 'b', 'all' => [1,2,3]];
        $array = $this->make($source);
        $array->clear(['a']);
    ...
    #[Test] public function clear_clears_nothing_with_empty_array()
    {
        $source = ['foo' => 'bar', 'a' => 'b', 'all' => [1,2,3]];
        $array = $this->make($source);
        $array->clear([]);
    ...
    #[Test] public function filter_filters_exact_matches()
    {
        $source = [
    ...
    #[Test] public function filter_filters_fuzzy_matches()
    {
        $source = [
            (object)['id' => 1, 'first_name' => 'Maria', 'last_name' => 'Tunningham', 'tags' => ['young','female']],
            (object)['id' => 2, 'first_name' => 'Marc', 'last_name' => 'I marc', 'tags' => ['young','male']],
